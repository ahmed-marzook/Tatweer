...
public class UserControllerTest {
  ...
  public void testCreateUser_Success() throws Exception {
    UserCreateDTO userCreateDTO = new UserCreateDTO("testuser", "John", "Doe", "john.doe@example.com");
  ...
  public void testCreateUser_ValidationFailure() throws Exception {
    ...
    mockMvc.perform(post("/api/users")
            ...
            .andExpect(jsonPath("$.errors[*].field").value(containsInAnyOrder("userName","firstName", "lastName", "email", "firstName", "lastName")))
  ...
  public void testCreateUser_UserNameAlreadyExists() throws Exception {
    UserCreateDTO userCreateDTO = new UserCreateDTO("existinguser", "John", "Doe", "john.doe@example.com");
  ...
  public void testCreateUser_EmailAlreadyExists() throws Exception {
    UserCreateDTO userCreateDTO = new UserCreateDTO("newuser", "John", "Doe", "existing@example.com");

    when(userService.addNewUser(any(UserCreateDTO.class)))
            .thenThrow(new EntityAlreadyExistsException("Email 'existing@example.com' is already registered"));
  ...
  public void testCreateUser_UnexpectedException() throws Exception {
    UserCreateDTO userCreateDTO = new UserCreateDTO("newuser", "John", "Doe", "john.doe@example.com");
